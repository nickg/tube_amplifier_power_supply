...
Modulator::Modulator(double Ts, double duty, double gate_hi_voltage, double gate_lo_voltage, double deadtime)
    : Ts(Ts), duty(duty), previous_duty(0.0), gate_hi_voltage(gate_hi_voltage), gate_lo_voltage(gate_lo_voltage), deadtime(deadtime), carrier(0.0), previous_carrier(0.0), interrupt_time(0.0),
