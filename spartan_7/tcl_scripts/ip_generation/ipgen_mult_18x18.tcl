...
if { [file isdirectory "IP/sign_mult_18x18/"] } {
    read_ip IP/sign_mult_18x18/sign_mult_18x18.xci
       ...
       -version 12.0 \
       -module_name sign_mult_18x18 -dir IP

       set_property -dict [list \
           CONFIG.Multiplier_Construction {Use_Mults} CONFIG.OptGoal {Speed} \
           CONFIG.PipeStages {0}] [get_ips sign_mult_18x18]
       generate_target {instantiation_template} [get_files IP/sign_mult_18x18/sign_mult_18x18.xci]

       set_property generate_synth_checkpoint false [get_files  IP/sign_mult_18x18/sign_mult_18x18.xci]

       generate_target all [get_files  IP/sign_mult_18x18/sign_mult_18x18.xci]

       export_ip_user_files \
           -of_objects [get_files IP/sign_mult_18x18/sign_mult_18x18.xci] \
           -no_script -sync -force -quiet

       export_simulation -of_objects [get_files IP/sign_mult_18x18/sign_mult_18x18.xci] \
           -directory IP/.ip_user_files/sim_scripts \
           -ip_user_files_dir IP/.ip_user_files \
           -ipstatic_source_dir IP/.ip_user_files/ipstatic \
           -lib_map_path [list \
               {modelsim=./.cache/compile_simlib/modelsim} \
